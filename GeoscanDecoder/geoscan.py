...
geoscan = construct.Struct(
    ...
    'ax25' / construct.If(lambda this: (bool(this.ax25) and this.ax25.addresses[0].callsign == u'BEACON'), ax25_header),
    'geoscan' / construct.If(lambda this: (bool(this.ax25) and this.ax25.pid == 0xF0), geoscan_frame),
)
